...
const Medoc = () => {
  ...
  <p>I completed my schooling at LIONS CALCUTTA GREATER VIDYA MANDIR and am now leveling up at FUTURE INSTITUTE OF TECHNOLOGY, exploring the vast map of life and technology. Currently, I’m working on projects like advance web development ,skin disease detection using machine learning etc, where I’m deploying my skills in machine learning, threejs and all other advanced webdev libraries , solidity and smart contracts etc to achieve victory.</p>
...
<div className='myprofilepic'> <img src={me} /></div>
      </div>
      <div className='rightmedoc'>
        <Canvas>
